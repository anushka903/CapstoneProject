...
def merge_salary_with_share(salary_file, stats_file, total_player_comp, output_file="Full Dataset 2021-2022.csv"):
    # Load CSVs
...
merge_salary_with_share(
    "NBA Salary Info 2021-2022 - Sheet1.csv",
    "NBA Player Stats 2021-2022 - Sheet1.csv",
    total_player_comp=5_000_000_000.00
)
